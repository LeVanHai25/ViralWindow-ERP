-- ============================================
-- SQL Script: Tạo các bảng BOM và Cutting Plan
-- ============================================

-- 1. Bảng door_bom_lines – BOM chi tiết từng cửa
...
-- Note: Foreign key sẽ được thêm sau khi đảm bảo door_drawings table tồn tại
...
-- 2. Bảng door_cutting_plan – Tối ưu cắt thanh nhôm
...
-- 4. Bảng door_bom_summary – Tổng hợp BOM theo nhóm vật tư
...
-- 5. Bảng projects_material_summary – Tổng hợp BOM toàn dự án
...
-- Insert materials mẫu
INSERT INTO materials (code, name, type, length_mm, price, unit) VALUES

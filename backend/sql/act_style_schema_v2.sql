-- =====================================================
-- DATABASE REFACTOR: ACT STYLE ARCHITECTURE
-- Version: 2.2 (Fix for phpMyAdmin FK error)
-- =====================================================
-- 
-- BƯỚC 1: Chạy phần XÓA trước (từ dòng 1 đến dòng 50)
-- BƯỚC 2: Sau đó chạy phần TẠO (từ dòng 51 trở đi)
--
-- =====================================================

-- =====================================================
-- PHẦN 1: XÓA TẤT CẢ (CHẠY RIÊNG PHẦN NÀY TRƯỚC)
-- =====================================================

SET FOREIGN_KEY_CHECKS = 0;

-- Xóa constraints trước
ALTER TABLE item_bom_lines DROP FOREIGN KEY IF EXISTS fk_ibl_bom_version;
ALTER TABLE item_bom_versions DROP FOREIGN KEY IF EXISTS fk_ibv_project_item;
ALTER TABLE item_bom_versions DROP FOREIGN KEY IF EXISTS fk_ibv_source_version;
ALTER TABLE item_structure_consumables DROP FOREIGN KEY IF EXISTS fk_isc_version;
ALTER TABLE item_structure_hardware DROP FOREIGN KEY IF EXISTS fk_ish_version;
ALTER TABLE item_structure_glass DROP FOREIGN KEY IF EXISTS fk_isg_version;
ALTER TABLE item_structure_aluminum DROP FOREIGN KEY IF EXISTS fk_isa_version;
ALTER TABLE item_config DROP FOREIGN KEY IF EXISTS fk_ic_version;
ALTER TABLE item_versions DROP FOREIGN KEY IF EXISTS fk_iv_project_item;
ALTER TABLE project_items_v2 DROP FOREIGN KEY IF EXISTS fk_piv2_current_version;
...
SELECT '✅ Phần 1 hoàn thành - Đã xóa tất cả bảng cũ!' as result;

-- =====================================================
-- PHẦN 2: TẠO BẢNG MỚI (CHẠY SAU KHI PHẦN 1 THÀNH CÔNG)
-- =====================================================

-- 1.1 project_items_v2
...
-- 2.5 item_structure_consumables
...
SELECT '✅ Phần 2 hoàn thành - Đã tạo tất cả bảng mới!' as result;

-- =====================================================
-- PHẦN 3: THÊM FOREIGN KEYS (TÙY CHỌN)
-- =====================================================
-- Nếu bạn muốn có foreign key constraints, chạy phần này
-- Nếu không cần, có thể bỏ qua

ALTER TABLE item_versions ADD CONSTRAINT fk_iv_project_item FOREIGN KEY (project_item_id) REFERENCES project_items_v2(id) ON DELETE CASCADE;
ALTER TABLE item_config ADD CONSTRAINT fk_ic_version FOREIGN KEY (item_version_id) REFERENCES item_versions(id) ON DELETE CASCADE;
ALTER TABLE item_structure_aluminum ADD CONSTRAINT fk_isa_version FOREIGN KEY (item_version_id) REFERENCES item_versions(id) ON DELETE CASCADE;
ALTER TABLE item_structure_glass ADD CONSTRAINT fk_isg_version FOREIGN KEY (item_version_id) REFERENCES item_versions(id) ON DELETE CASCADE;
ALTER TABLE item_structure_hardware ADD CONSTRAINT fk_ish_version FOREIGN KEY (item_version_id) REFERENCES item_versions(id) ON DELETE CASCADE;
ALTER TABLE item_structure_consumables ADD CONSTRAINT fk_isc_version FOREIGN KEY (item_version_id) REFERENCES item_versions(id) ON DELETE CASCADE;
ALTER TABLE item_bom_versions ADD CONSTRAINT fk_ibv_project_item FOREIGN KEY (project_item_id) REFERENCES project_items_v2(id) ON DELETE CASCADE;
ALTER TABLE item_bom_versions ADD CONSTRAINT fk_ibv_source_version FOREIGN KEY (source_item_version_id) REFERENCES item_versions(id) ON DELETE RESTRICT;
ALTER TABLE item_bom_lines ADD CONSTRAINT fk_ibl_bom_version FOREIGN KEY (bom_version_id) REFERENCES item_bom_versions(id) ON DELETE CASCADE;
ALTER TABLE project_items_v2 ADD CONSTRAINT fk_piv2_current_version FOREIGN KEY (current_version_id) REFERENCES item_versions(id) ON DELETE SET NULL;

SELECT '✅ Phần 3 hoàn thành - Đã thêm Foreign Keys!' as result;
SELECT '✅ ACT Style Schema v2.2 - HOÀN THÀNH!' as final_result;
